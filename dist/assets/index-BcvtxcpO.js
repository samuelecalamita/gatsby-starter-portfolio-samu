(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const u=document.querySelector("#canvas");async function p(){if(!u)return;const o=await import("https://cdn.jsdelivr.net/npm/three@0.179.1/build/three.module.js"),r=new o.Scene,s=new o.OrthographicCamera(-1,1,1,-1,0,1),e=new o.WebGLRenderer({canvas:u,antialias:!0,alpha:!0}),t={uTime:{value:0},uResolution:{value:new o.Vector2(1,1)},uPointer:{value:new o.Vector2(.5,.5)},uColors:{value:[new o.Color("#010157"),new o.Color("#2323d9"),new o.Color("#51e334"),new o.Color("#a0d8f1")]}},n=new o.ShaderMaterial({uniforms:t,vertexShader:`
    ...
    `}),f=new o.Mesh(new o.PlaneGeometry(2,2),n);r.add(f);function c(){const i=window.innerWidth,a=window.innerHeight,h=Math.min(window.devicePixelRatio||1,2);e.setPixelRatio(h),e.setSize(i,a,!1),t.uResolution.value.set(i,a)}function m(i){t.uPointer.value.set(i.clientX/window.innerWidth,1-i.clientY/window.innerHeight)}c(),window.addEventListener("resize",c),window.addEventListener("pointermove",m,{passive:!0});const v=new o.Clock;function l(){t.uTime.value=v.getElapsedTime(),e.render(r,s),window.requestAnimationFrame(l)}l()}p();
